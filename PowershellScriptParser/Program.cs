...
namespace PowershellScriptParser
{
    public class Program
    {
        static async Task Main(string[] args)
        {
            ...
            var functions = await GetFunctions(filePath);
            foreach (var function in functions)
            {
                Console.WriteLine($"{function.StartLine}-{function.EndLine}  {function.Name}");
            }

            var executions = await GetFunctionExecutions(filePath, functions);
        ...
        private static async Task<List<Function>> GetFunctions(string filePath)
        {
        ...
        private static async Task<List<FunctionExecution>> GetFunctionExecutions(string filePath,
